    ...
    <>
      <main className="flex flex-col gap-12">
              ...
              <div className="text-center flex flex-col gap-6">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  <Link href="/services" as="/services">
                    <button type="button" className="w-full sm:w-auto px-6 py-3 text-lg font-medium rounded-xl bg-teal-600 text-white shadow-lg hover:bg-teal-700 transition active:scale-95">
                      Learn More
                    </button> 
                  </Link>
                  <Link href="/contact" as="/contact">
                    <button type="button" className="w-full sm:w-auto px-6 py-3 text-lg font-medium rounded-xl bg-white text-neutral-600 ring-1 ring-neutral-300 shadow-lg hover:bg-gray-50 transition active:scale-95">
                      Contact Us
                    </button>
                  </Link>
                </div>
              ...
              <div className="bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl">
                <div className="p-6 flex flex-col gap-6">
                  ...
                  <Link href="/products" as="/products">
                    <button className="w-full inline-flex items-center justify-center px-4 py-2 gap-2 border border-transparent text-sm font-medium rounded-xl shadow-sm text-white bg-teal-600 hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 transition active:scale-95">
                      Learn More
        ...
        <section className="w-9/12 mx-auto flex flex-col gap-6">
          <h2 className="text-2xl font-semibold text-center text-gray-800">Technologies We Use</h2>
          <div className="flex flex-wrap justify-center gap-3">
            {['React', 'Node.js', 'Python', 'AWS', 'Docker', 'Kubernetes', 'TensorFlow', 'GraphQL'].map((tech) => (
              <span key={tech} className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-teal-100 text-teal-800">
                {tech}
              </span>
            ))}
          </div>
          <div className="space-y-6 text-gray-600">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white p-6 rounded-xl shadow-md">
                <h3 className="text-lg font-semibold text-teal-600">Frontend Excellence</h3>
              ...
              <div className="bg-white p-6 rounded-xl shadow-md">
                <h3 className="text-lg font-semibold text-teal-600">Backend Power</h3>
              ...
              <div className="bg-white p-6 rounded-xl shadow-md">
                <h3 className="text-lg font-semibold text-teal-600">Cloud & DevOps</h3>
              ...
              <div className="bg-white p-6 rounded-xl shadow-md">
                <h3 className="text-lg font-semibold text-teal-600">AI Integration</h3>
        ...
        <section className="py-16 mex-auto text-center flex flex-col gap-6 bg-teal-600">
            <h2 className="text-2xl font-bold text-white">Ready to Transform Your Business?</h2>
            <p className="text-lg sm:text-xl text-white">Let's discuss how can we help you</p>
            <Link href="/contact" as="/contact">
              <button className="inline-flex items-center px-6 py-3 gap-3 border border-transparent text-base font-medium rounded-xl text-teal-600 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-teal-600 focus:ring-white transition active:scale-95">
                Get in Touch
